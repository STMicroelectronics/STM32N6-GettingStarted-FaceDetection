# Release Notes for STM32N6-GettingStarted-FaceDetection Application

## Purpose

Face Detection application to enable the deployment of face detection models on STM32N6570-DK and NUCLEO-N657X0-Q boards.

This application is prebuilt with a face detection model.
...
| ai-postprocessing-wrapper                   |  v1.1.0             | [release notes](Middlewares/ai-postprocessing-wrapper/Release_Notes.md)
